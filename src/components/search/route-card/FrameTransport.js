...
function FrameTransport({number_of_transport, type_of_transport}) {
    // Возвращаем JSX-код
    return (
        <div className="frame__routecard">
            <p className="text_type__routecard">Вид транспорта</p>
            <div className="type_of__routecard">
                ...
                <p className="text_content__routecard">{type_of_transport} {number_of_transport}</p>
            </div>
        </div>
