            ...
            <footer>
                <div className="content">
                    <div className="links">
                        ...
                        <a id="search" className="footer__link" href="/search">Поиск</a>
                        <a id="map" className="footer__link" href="/map">Карта</a>
                        <a id="catalog" className="footer__link" href="/catalog">Каталог</a>
                ...
                <div className="credits">
                    ...
                    <div className="row">
                        ...
                        <div className="commercial__links">
                            <a className="href">Политика конфиденциальности</a>
                            <a className="href">Условия использования</a>
                            <a className="href">Настройки файлов cookie</a>
                        </div>
                    </div>
                </div>
            </footer>
